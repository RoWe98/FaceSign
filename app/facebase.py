...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def show_camera(self):
        ...
        cv2.putText(self.image, "FaceNum:" + str(len(faces)), (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        cv2.putText(self.image, "Press 'Q' to Quit!", (250, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

        for (x, y, w, h) in faces:
            pixel_1 = int(w / 2 + x)
            pixel_2 = int(y - h / 5)
            cv2.rectangle(self.image, (x, y), (x + w, y + w), (0, 255, 0), 2)
            cv2.putText(self.image, "face", (pixel_1, pixel_2), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
